    ...
    <div class="page-wrapper animate__animated animate__fadeIn">
        <main>
            ...
            <div class="quick-access"><a href="#" class="main-resource-link"><i
                        class="fas fa-book-open"></i><span>Honours 1st Year Resources</span><i
                        class="fas fa-chevron-down"></i></a></div>
            <div class="section-title">
                <h3>Quick Access</h3>
            </div>
            <div class="button-grid">
                <a href="lectures.php?year=1" class="grid-button"><i class="fas fa-chalkboard-teacher"></i><span>Class
                        Lectures</span></a>
                <a href="notes.php?year=1" class="grid-button"><i class="fas fa-pencil-alt"></i><span>Hand
                        Notes</span></a>
                <a href="question.php?year=1" class="grid-button"><i class="fas fa-question-circle"></i><span>NU
                        Questions</span></a>
                <a href="suggestions.php?year=1" class="grid-button"><i
                        class="fas fa-lightbulb"></i><span>Suggestions</span></a>
                <a href="routines.php?year=1" class="grid-button"><i
                        class="fas fa-calendar-alt"></i><span>Routines</span></a>
                <a href="books.php?year=1" class="grid-button"><i class="fas fa-book"></i><span>Explore Reads</span></a>
                <a href="department.php" class="grid-button"><i class="fas fa-university"></i><span>Our
                        Department</span></a>
                <a href="assignments.php?year=1" class="grid-button"><i class="fas fa-file-alt"></i><span>Assignments & Practicals</span></a>
            </div>
...
<?php
$year_for_page = 1; // Set for 1st Year
...
<!-- ===== END: FINAL ANNOUNCEMENT CAROUSEL ===== -->
            ...
            <div class="recent-uploads">
                <div class="section-title">
                    <h3>Recently added</h3><a href="updates.php?year=1" class="see-all">See all</a>
                </div>
                <div class="upload-list">
                    <?php
                    // MODIFIED QUERY: We now also fetch the 'category' for YEAR 1
                    $sql = "SELECT id, title, file_link, preview_link, category FROM uploads WHERE academic_year = 1 ORDER BY upload_date DESC LIMIT 3";
...
<div class="helpful-links-section">
    ...
    <div class="quick-links">
        <a href="https://saadatcollege.eshiksaems.com/college_student_panel" class="quick-link-item">
            <span>Student Dashboard (College EMS)</span>
            <i class="fa-solid fa-user-graduate"></i>
        </a>
        <a href="https://www.saadatcollege.gov.bd/noticeboardview" class="quick-link-item">
            <spam>Govt. Saadat College Noticeboard</spam>
            <i class="fas fa-bullhorn"></i>
            </a>
        <a href="https://www.saadatcollege.gov.bd/" class="quick-link-item">
            <spam>Govt. Saadat Colege Official Website</spam>
