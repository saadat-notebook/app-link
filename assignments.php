...
<body>
    <script>
    (function() { try { if (document.cookie.includes("PHPSESSID")) { const bottomNavHTML = `<nav class="bottom-nav"><a href="index.php" class="nav-link nav-home-link"><i class="fas fa-home"></i><span>Dashboard</span></a><a href="profile.php" class="nav-link"><i class="fas fa-user-circle"></i><span>Profile</span></a><a href="bcs-math.html" class="nav-link"><i class="fas fa-square-root-alt"></i><span>BCS Maths</span></a></nav>`; document.write(bottomNavHTML); } } catch(e) {} })();
    </script>
    ...
    <div class="page-wrapper animate__animated animate__fadeIn">
        <main>
            ...
            <div class="content-card"
                ...
                <div class="card-body">
                    <div class="card-content-wrapper">
                        ...
                        <?php endif; ?>
                        <?php if ($has_videos): ?>
                           <!-- Video player code from previous steps would go here -->
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <?php
                ...
                echo '<p class="placeholder-text" style="text-align:center; color: var(--text-secondary);">No assignments have been uploaded for this year yet.</p>';
            endif;
            echo '</div>'; 
            ?>
        </main>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (mainContent) {
            mainContent.addEventListener('click', function(e) {
                const header = e.target.closest('.content-card .card-header');
                if (!header) return;
