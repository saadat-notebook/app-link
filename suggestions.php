...
<head>
    ...
    <title>Suggestions (Year
        <?php echo $year_to_show; ?>) - Saadat Notebook
    </title>
...
<body>
    ...
    <div class="page-wrapper animate__animated animate__fadeIn">
        <main>
            <h1 class="page-title">Suggestions - Honours
...
$sql = "SELECT id, title, file_link, preview_link, description, video_links_json 
        FROM uploads WHERE category = 'Suggestions' AND academic_year = $year_to_show ORDER BY upload_date DESC";
    ...
    data-videos-json='<?php echo htmlspecialchars($row['video_links_json'] ?? '[]', ENT_QUOTES, 'UTF-8'); ?>'>
                ...
                <?php
                    ...
                    echo '<p>No suggestions have been uploaded for this year yet.</p>';
                endif;
                ?>
            </div>
        </main>
