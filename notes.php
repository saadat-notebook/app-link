...
<head>
    ...
    <title>Hand Notebook (Year <?php echo $year_to_show; ?>) - Saadat Notebook</title>
...
<body>
    ...
    <div class="page-wrapper animate__animated animate__fadeIn">
        <main>
            <h1 class="page-title">Hand Notebook - Honours <?php echo $year_to_show; echo ($year_to_show == 1) ? 'st' : 'nd'; ?> Year</h1>
            ...
            <div class="subject-filter-container" id="subject-filter-container">
                ...
                <div class="filter-buttons-grid">
                    ...
                    foreach ($subjects_for_this_year as $subject) {
                        ...
                        $sql_check = "SELECT id FROM uploads WHERE category = 'Hand Notes' AND subject = '$safe_subject_check' AND academic_year = $year_to_show LIMIT 1";
            ...
            foreach ($subjects_for_this_year as $subject):
                ...
                $sql = "SELECT id, title, file_link, preview_link, description, video_links_json 
                        FROM uploads 
                        WHERE category = 'Hand Notes' AND subject = '$safe_subject' AND academic_year = $year_to_show 
